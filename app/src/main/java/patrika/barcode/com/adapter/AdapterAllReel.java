...
import patrika.barcode.com.activity.AllReel;
...
public class AdapterAllReel extends RecyclerView.Adapter<AdapterAllReel.MyViewHolder> {

    private Context context;
    ArrayList<DepthReel.ResponseBean.DataBean> list= new ArrayList<>();


    public AdapterAllReel(AllReel context, ArrayList<DepthReel.ResponseBean.DataBean> list) {
